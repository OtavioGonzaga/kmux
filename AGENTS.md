...
Use `AGENTS.md` as the shared entry point for instructions for all AI coding agents. Keep agent files in `.agents/` and avoid tool/vendor-specific directories.
